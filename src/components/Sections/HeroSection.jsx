      ...
      <div className="z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center w-full relative">
        <div className="order-2 lg:order-1 relative z-20">
          ...
          <h1 className="font-headline-xl text-[48px] md:text-[64px] lg:text-[100px] leading-[0.9] mb-6 font-bold tracking-tighter text-text-primary uppercase">
            ARTHUR <br /> <span className="text-primary-light">ROSISCA</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4">
            <ScrollLink to="contact" smooth={false} duration={0} containerId="main-scroll-container" className="bg-primary-fixed text-on-primary-fixed depth-btn-primary font-bold px-6 py-3 text-sm uppercase tracking-widest rounded-[12px] cursor-pointer">
              {t('hero.cta_contact')}
            </ScrollLink>
            <ScrollLink to="projects" smooth={false} duration={0} containerId="main-scroll-container" className="glass-panel depth-btn-secondary border border-primary-fixed/30 text-on-surface font-bold px-6 py-3 text-sm uppercase tracking-widest rounded-[12px] cursor-pointer">
              {t('hero.cta_projects')}
            </ScrollLink>
          </div>
          <div className="flex items-center gap-6 mt-8">
            <a className="text-on-surface-variant social-glow-hover transition-all duration-300 transform hover:scale-110 cursor-pointer" href="https://www.linkedin.com/in/artrosisca/" target="_blank" rel="noopener noreferrer">
            ...
            <a className="text-on-surface-variant social-glow-hover transition-all duration-300 transform hover:scale-110 cursor-pointer" href="https://github.com/artrosisca" target="_blank" rel="noopener noreferrer">
              <svg className="w-6 h-6 fill-current" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <title>GitHub</title>
